...
/datum/asset/spritesheet/simple/paper
	name = "paper"
	assets = list(
		"stamp-clown" = 'icons/paperwork_icons/large_stamp-clown.png',
		"stamp-deny" = 'icons/paperwork_icons/large_stamp-deny.png',
		"stamp-ok" = 'icons/paperwork_icons/large_stamp-ok.png',
		"stamp-hop" = 'icons/paperwork_icons/large_stamp-hop.png',
		"stamp-cmo" = 'icons/paperwork_icons/large_stamp-cmo.png',
		"stamp-ce" = 'icons/paperwork_icons/large_stamp-ce.png',
